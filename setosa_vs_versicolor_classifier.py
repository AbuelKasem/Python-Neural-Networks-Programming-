...
setosa_vs_versicolor_desired_out=setosa_desired_classification[setosa_desired_classification_slice]

print(setosa_desired_classification)
print(setosa_vs_versicolor_desired_out)
training_set_setosa_vs_versicolor_slice=slice(0,60,1) 
setosa_vs_versicolor_train_set=training_set[training_set_setosa_vs_versicolor_slice]
l=1

e=0
n_it=50
def setosa_vs_versicolor_model_train(training_data,desired_output,iter_limit,learning_rate):
  n_err=0
  n_correct=0
...
setosa_vs_versicolor_model_weights,setosa_vs_versicolor_model_out=setosa_vs_versicolor_model_train(setosa_vs_versicolor_train_set,setosa_vs_versicolor_desired_out,n_it,l) #call the training function ,pass training data set,desired output ,number of iterations ,learning rate
                                        #store the output weigths of the model and estimated output in two variables
print(f'setosa_vs_versicolor_model_weights={setosa_vs_versicolor_model_weights}')
print(f'setosa_vs_versicolor_model_out={setosa_vs_versicolor_model_out}') 
#print(versicolor_desired_classification)
def setosa_vs_versicolor_classify(sample,model):
...
d2=setosa_vs_versicolor_classify(test_s,setosa_vs_versicolor_model_weights) #pass data to classifier with the trained model 
print(f'd2={d2}')  
